const CACHE="tattoo-dice-admin-panel-v23";
const FILES=["/admin/","/admin/index.html","/admin/live/","/admin/live/index.html","/admin/live/live-shell.css?v=1","/admin/admin-panel.css?v=2","/admin/admin-panel.js?v=2","/admin/admin-nav.js?v=1","/admin/manifest.webmanifest","/admin/assets/admin-ranking-header.png","/admin/assets/admin-icon-192.png","/admin/assets/admin-icon-512.png"];
