const CACHE="tattoo-dice-admin-panel-v22";
const FILES=["/admin/","/admin/index.html","/admin/admin-panel.css?v=1","/admin/admin-panel.js?v=1","/admin/admin-nav.js?v=1","/admin/manifest.webmanifest","/admin/assets/admin-ranking-header.png","/admin/assets/admin-icon-192.png","/admin/assets/admin-icon-512.png"];
