...
Internal landscape curation sheet at `/admin/canon/`.

## Deliberately simple

Canon mirrors the Excel master: Word, Score, automatic Weight, Main, Detail, Effect, Family and Notes. The active theme is selected at the top. A new theme starts with a dedicated word-selection page; selected words inherit their complete existing profile automatically.

Testing does not happen in Canon. All combination ranking remains in `/admin/ranking/`.
